...
const Awards = () => {
    return (
        <div className="container-awards p-3 container-flex bg-light">
            ...
            <div className="row">
                ...
                <div className="col-xxl-6 col-xl-4 col-lg-5 col-md-7 col-sm-12 col-xs-12">
                    <div className="box p-3">
                        <h5 className="hedah h3 p-1 rounded-2 text-center p-3">Innovation Award for the outstanding quality.</h5>
