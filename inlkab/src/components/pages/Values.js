    ...
    return (
        <div className="container-values p-2 border rounded bg-white">
            <div className="brif-sub rounded bg-light border">
                <h1 className="head-histry display-6 text-center fw-bold text-dark p-2 mt-5">A brief history on Inklab</h1>
            ...
            <h1 className="head-values display-6 text-center fw-bold p-3 mt-5 text-dark">Our Core Values</h1>
            ...
            <div className="row">
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h5 p-1 text-dark bg-light border mt-2 rounded">Creativity</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h5 p-1 text-dark bg-light border mt-2 rounded">Collaboration</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h5 p-1 text-dark bg-light border mt-2 rounded">Integrity</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h5 p-1 text-dark bg-light border mt-2 rounded">Excellence</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h5 p-1 text-dark bg-light border mt-2 rounded">Innovation</h3>
                    </div>
                </div>
