            ...
            <div className="row">
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h6 p-1 border mt-2 rounded fw-bold">Creativity</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h6 p-1 border mt-2 rounded fw-bold">Collaboration</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h6 p-1 border mt-2 rounded fw-bold">Integrity</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h6 p-1 border mt-2 rounded fw-bold">Excellence</h3>
                    </div>
                </div>
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6">
                    <div className="box-values container">
                        ...
                        <h3 className="value text-center h6 p-1 border mt-2 rounded fw-bold">Innovation</h3>
                    </div>
                </div>
