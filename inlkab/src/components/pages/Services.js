    ...
    return (
        <div className="container-service bg-white">
            ...
            <div className="cont-digitalprinting bg-white p-2">
                <h1 className="head-digitalprint rounded p-2 text-center h5lay-6 fw-bold pt-5">Digital Printing</h1>
            <h1 className="header-subservice h6 text-center text-dark pb-5">Digital printing is a modern printing method that offers high-quality and cost-effective solutions for both small and large-scale projects. Ideal for vibrant graphics and intricate details, this service is perfect for business cards, flyers, brochures, banners, and more.</h1>
                ...
                <div className="row">
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Margazines</h3>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Bronchures</h3>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Fliers</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Calendars</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Eulogies</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Diaries</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Books</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Notebooks</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Posters</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Letterhead</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Stickers</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Staff IDs</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Envelopes</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Receipt Books</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Certificates</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Gift Bags</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        ...
                        <a href={tentcards} target="_blank" rel="noopener noreferrer">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Tent Cards</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4  col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Packaging</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Business Cards</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Product Labels</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Wedding Cards</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Photo Mounting</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1">Presentation Folder</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                        <div className="box-digitalprinting rounded container bg-white">
                            ...
                            <h3 className="h3-clients1 h6 text-center fw-bold p-1"> Custom Cellotapes</h3>
                            <h3 className="h3-clients h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
