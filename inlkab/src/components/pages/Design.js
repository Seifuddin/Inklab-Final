                ...
                <div className="row">
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Graphic Design</h1>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Animations/ Cartoons</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">2D/ 3D Design</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Video Adverts</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Video Editing</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Web Development</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">App Development</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-3 col-xxl-3 col-6">
                        <div className="box-digitalprinting border border-3 rounded container bg-white">
                            ...
                            <h1 className="h3-clients1 h6 text-center fw-bold p-1 text-dark">Hand Drawing</h1>
                            <h3 className="h3-clothes2 h6 text-center">From Kshs. 100 - Kshs. 100 per A3 size </h3>
                            <button className="btn-quotation h6 text-center m-2 border rounded p-2 rounded" onClick={handleButtonClick}> Quoatation </button>
                        </div>
                    </div>
