...
const TheTeam = () => {
    ...
    return (
        <div className="container-theteam border rounded mt-5 bg-light">
            <h1 className="head-theteam display-6 fw-bold text-center pb-3">The Team</h1>
            ...
            <div className="row">
                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div className="box-theteam container p-3 rounded bg-white">
                        ...
                        <h5 className="service1 text-center rounded border bg-light mt-2 h5 fw-bold p-2">Chris - Chief Graphic Designer</h5>
