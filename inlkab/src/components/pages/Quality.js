...
const Quality = () => {
    ...
    return (
        <div className="container-quality cont border rounded m-5 bg-light p-3">
            <h1 className="header-quality text-center display-4 fw-bold p-3"> Quality Assurance </h1>
            <p className="heada-quality2 text-center h3 p-3 text-primary"> At Inklab Graphics, quality is at the core of everything we do. Our team performs a two-step quality inspection on each project, checking for color accuracy, clarity, and allignment. Equipped with Modern Konika Minolta Printers, we deliver precision and sharp detail on every print. We also use FSC-certified paper and faderesistant inks, offering clients eco-friendly long-lasting results. With industry-leading certifications and a customer-first approach, we ensure every project meets our rigorous standards. </p>
            < div className="row m-2">
                <div className="col">
                    <div className="box-quality container bg-warning p-3">
                    ...
                    <h1 className="head-quality text-center h3 m-4 bg-primary text-white rounded"> In-House Checks and Proofing process</h1>
                ...
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 bg-primary text-white rounded"> Advanced Technology Printing </h1>
            ...
            < div className="row m-2">
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 bg-primary text-white rounded"> Top Quality Materials </h1>
                ...
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 bg-primary text-white rounded"> Continous Improvement and and Regular maintenance </h1>
