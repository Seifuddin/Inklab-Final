...
const Quality = () => {
    ...
    return (
        <div className="container-quality cont border rounded mt-5 bg-white p-3">
            <h1 className="header-quality text-center display-4 fw-bold p-3"> Quality Assurance </h1>
            <p className="heada-quality2 text-center h3 p-3 text-primary"> At Inklab Graphics, quality is at the core of everything we do. Our team performs a two-step quality inspection on each project, checking for color accuracy, clarity, and allignment. Equipped with Modern Konika Minolta Printers, we deliver precision and sharp detail on every print.</p>
            < div className="row m-2">
                <div className="col">
                    <div className="box-quality container bg-light p-3">
                    ...
                    <h1 className="head-quality text-center h3 m-4 text-warning rounded"> In-House Checks and Proofing process</h1>
                ...
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 text-warning rounded"> Advanced Technology Printing </h1>
            ...
            < div className="row m-2">
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 text-warning rounded"> Top Quality Materials </h1>
                ...
                <div className="col">
                    ...
                    <h1 className="head-quality text-center h3 m-4 text-warning rounded"> Continous Improvement and and Regular maintenance </h1>
