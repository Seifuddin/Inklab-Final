...
const Ourservices = () => {
    ...
    return (
        <div className="container-services p-2 bg-light border">
                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Digital Printing</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Large Format Printing</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Cloth Branding</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Signages</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Graphic Design</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Web Design</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">Video Advertising</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border bg-light h4 fw-bold text-dark p-1">3D/ 2D Design</h1>
