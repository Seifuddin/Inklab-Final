...
import d2 from '../images/6-5mm-led-acrylic-letter-sign-board-500x500.jpeg';
                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Digital Printing</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Large Format Printing</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Cloth Branding</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Signages</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Graphic Design</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Web Design</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">Video Advertising</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            <a href={d2} target="_blank" rel="noopener noreferrer">
                                <img className='imej-printing' src={d2} alt='3d' />
                            </a>
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">2D Design</h1>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="box-service">
                            ...
                            <h1 className="service-1 text-center rounded border h6 fw-bold p-1">3D Design</h1>
                            <p className="h-service">Unlock the power of creativity with our 2D and 3D design services. Whether you need detailed illustrations, product mockups, architectural models, or 3D animations, our skilled designers bring your ideas to life with precision and artistic flair. </p>
                        </div>
                    </div>
